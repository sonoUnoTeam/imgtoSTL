...
img_original = cv2.imread(r'C:\Users\cotif\Documents\GitHub\imgtoSTL\imgs\-helix-nebula.jpg.jpeg')
...
for i in range(h):
    for j in range(w):
        ...
        # WHITE
        if 100 >= pR >= 30 and 100 >= pG >= 35 and 100 >= pB >= 35:
        ...
        if 100 >= pR >= 20 and 30 >= pG >= 0 and 50 >= pB >= 0:
            ...
            if pixel[0] == 0 and pixel[1] == 0 and pixel[2] == 0:
                ...
                z[i, j] = 48
            # RED
        if 100 >= pR >= 20 and 25 >= pG >= 0 and 30 >= pB >= 0:
            pr[i, j] = pixel
            if pixel[0] == 0 and pixel[1] == 0 and pixel[2] == 0:
                x[i, j] = j
                y[i, j] = i
                ...
                z[i, j] = 49
            # DARK RED 
        if 70 >= pR >= 20 and 25 >= pG >= 0 and 10 >= pB >= 0:
            pr[i, j] = pixel
            if pixel[0] == 0 and pixel[1] == 0 and pixel[2] == 0:
                x[i, j] = j
                y[i, j] = i
            ...
            pb[i, j] = pixel
             #  LIGHT CYAN
        elif 75 >= pR >= 0 and 100 >= pG >= 50 and 100 >= pB >= 30:
            if pixel[0] == 0 and pixel[1] == 0 and pixel[2] == 0:
                x[i, j] = j
                y[i, j] = i
                z[i, j] = 6
        ...
        # YELLOW
            ...
            py[i, j] = pixel
            #DARK YELLOW
        elif 80 >= pR >= 40 and 80 >= pG >= 20 and 50 >= pB >= 10:
            if pixel[0] == 0 and pixel[1] == 0 and pixel[2] == 0:
                x[i, j] = j
                y[i, j] = i
                z[i, j] = 6
